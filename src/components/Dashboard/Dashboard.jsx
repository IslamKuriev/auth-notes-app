    ...
    <div className={styles.main}>
      ...
      <div className={styles.describe}>
        <input
          ...
          className={styles.inputDescribe}
          type="text"
        ...
        <span style={{ marginBottom: '5px' }}>Выбери цвет блока</span>
        <input type="color" value={colorBlock} onChange={(e) => setColorBlock(e.target.value)} />
        <span style={{ marginBottom: '5px' }}>Выбери цвет текста</span>
          ...
          filtered.map((note) => {
            return (
              <div
                ...
                style={{ backgroundColor: note.colorBlock }}>
                ...
                <button
                  ...
                  <img src="./pensil.svg" alt="Изменить" />
                </button>
                <button className={styles.btnAction} onClick={() => handleRemoveNote(note.id)}>
